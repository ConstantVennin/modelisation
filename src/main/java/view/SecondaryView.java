...
public class SecondaryView extends Stage implements IView, Observer {
	...
	public SecondaryView(View mainView, Model model) {
		...
		canvas.setTransformedData(model.getData());
	}
	...
	public boolean computeShadows() {
		return mainView.computeShadows();
	}

	@Override
	public double getShadowStrength() {
		return mainView.getShadowStrength();
	}

	@Override
	public double getLightStrength() {
		return mainView.getLightStrength();
	}
