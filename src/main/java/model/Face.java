...
public class Face {
	 ...
	 */
	public Face(int[] points, Couleur color) {
		this.points = points;
		this.color = color;
	...
	public Face(Face face) {
		...
		if (face.colorInit == null) {
			this.colorInit = null;

		} else {
			this.colorInit = new Couleur(face.getColorInit());
		}
		this.color = null;
	}
	...
	public void faceColoringAverage(Map<Integer, Point> listPoint, int[] listPoints) {
		...
		this.colorInit = new Couleur(totalRed / n, totalGreen / n, totalBlue / n, totalAlpha / n);
	}
	...
	public void setFaceColorFromPLY(String[] parameters, Map<Integer, Point> listPointModel, int[] listPointsFace) {
		if (Integer.parseInt(parameters[0]) + 4 == parameters.length) {
			color = new Couleur(Integer.parseInt(parameters[Integer.parseInt(parameters[0]) + 1]),
