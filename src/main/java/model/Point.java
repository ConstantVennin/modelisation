...
public class Point {
	 ...
	 */
	public Point(double x, double y, double z, Couleur color) {
	...
	public Point(double x, double y, double z) {
		this(x, y, z, new Couleur(255, 255, 255));
	}
	...
	public Point(Point point) {
		this(point.get(0), point.get(1), point.get(2), new Couleur(point.getColor()));
	}
