...
/**
 * Cette classe sert à stocker tous les points dans une map (avec donc un
...
public class PLYData {
	...
	/**
	 * Cr�er un objet data a partir d'une liste de points et d'une liste de faces
	 * 
	...
	/**
	 * Instantie une copie de la data pass�e en parametre
	 * 
	 * @param data la data � copier
	 */
	...
	/**
	 * Retourne le point correspondant � l'id
	 * 
	 * @param id l'id
	...
	/**
	 * Ajoute une face � la liste des faces
	 * 
	 * @param face la face
	 */
	...
	/**
	 * Applique une transformation de matrice "transformationMatrix" � tous les
	 * points de la data
	 * 
	...
	/**
	 * Recup�re la coordon�e minimale de tous les points
	 * 
	 * @param i (x=0 y=0 z=0)
	 * @return la coordonn�es
	 */
	...
	/**
	 * Recup�re la coordon�e maximale de tous les points
	 * 
	 * @param i (x=0 y=0 z=0)
	 * @return la coordonn�es
	 */
	...
	/**
	 * Retourne la moyenne des coordon�e de tous les points Utilis� pour avoir une
	 * approximation de l'echelle du mod�le � son chargement
	 * 
	 * @return la moyenne
	 */
